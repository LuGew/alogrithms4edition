package com.lugew.alogrithms4edition.graphs.directedGraphs.exercises.p4231;
...
public class EulideanDigraph {
    ...
    public EulideanDigraph(String fileName) throws FileNotFoundException {
